...
namespace QuanLyThuVien
{
    class ReportService
    {
        ...
        public string SachMat(DateTime dtTu, DateTime dtDen)
        {
            ...
            else
            {
                ...
                {                    
                    ...
                    strHTML += "<td width='77'><font size='2'>" + dr["MaSach"].ToString() + "</font></td>";
                    strHTML += "<td width='217'><font size='2'></font>" + dr["TenSach"].ToString() + "</font></td>";
                    intDonGia = Convert.ToInt32(dr["DonGia"]);
                    strHTML += "<td width='46' align='right'><font size='2'>&nbsp;" + intDonGia.ToString() + "</font></td>";
                    strHTML += "<td width='97' align='left'><font size='2'>&nbsp;" + dr["GhiChu"].ToString() + "</font></td>";
                    strHTML += "</tr>";
                    intTongTien += intDonGia;
                }
                strHTML += "<tr>";
        ...
        //                DataTable dtGB = clsDAO.GetInfo(Convert.ToInt32(dr["MaSach"]));                        
