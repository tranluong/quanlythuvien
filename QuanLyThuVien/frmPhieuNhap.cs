    ...
    public partial class frmPhieuNhap : Form
    {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string MaPN = Convert.ToString(vr.Cells[6].Value);
                ...
                {
                    pn.pMaPhieuNhap = Convert.ToInt32(vr.Cells[6].Value);
                    pn.pMaSach = Convert.ToInt32(vr.Cells[5].Value);
                    double thanhTien = pnDao.getThanhTien(int.Parse(MaPN), Convert.ToInt16(vr.Cells[5].Value));
                    double tongTien = pnDao.getTongTien(int.Parse(MaPN));
                    double tongTriGia = tongTien - thanhTien;
                    if (pnDao.updateTongTien(int.Parse(MaPN), tongTriGia))
                    {
        ...
        private void btnCapnhat_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                pn.pMaPhieuNhap = Convert.ToInt32(dataGridView2.CurrentRow.Cells[6].Value);
                PhieuNhapService pnService = new PhieuNhapService();
                ...
                {
                    //int sLuongSach = pnService.getSLSach(Convert.ToInt32(dataGridView2.CurrentRow.Cells[5].Value));
                    //int sLuongUpdate = Convert.ToInt32(txtSL.Text.Trim());
                    //int SL = sLuongSach + sLuongUpdate;
                    //if (pnDao.capNhatSLSach(Convert.ToInt32(dataGridView2.CurrentRow.Cells[5].Value),SL))
                    //{
                    //    MessageBox.Show("Cập nhật thành công", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    //}   

                    dataGridView2.DataSource = pnDao.HienThiChiTietPhieuNhap(Convert.ToInt32(dataGridView2.CurrentRow.Cells[6].Value));
                    for (int i = 0; i < dataGridView2.Rows.Count; i++)
                    {
                        tongtien += Convert.ToInt32(dataGridView2.Rows[i].Cells["Thành Tiền"].Value);
                    }
                    if (pnDao.updateTongTien(Convert.ToInt32(dataGridView2.CurrentRow.Cells[6].Value), tongtien))
                    {
                        MessageBox.Show("Cập nhật thành công", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                        gridPhieuNhap.DataSource = pnService.HienThiPhieuNhap();
                    }
        ...
        public void loadPhieuNhap()
        {
            PhieuNhapService pn = new PhieuNhapService();
            PhieuNhapDao pnDao = new PhieuNhapDao();
            DataTable dt = pn.HienThiPhieuNhap();
            if (dt.Rows.Count != 0)
            {
                ...
                cboMaSach.SelectedValue = dataGridView2.CurrentRow.Cells[5].Value.ToString();
                txtSL.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
                txtDG.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();
                txtTT.Text = dataGridView2.CurrentRow.Cells[4].Value.ToString();
        ...
        private void btnThem_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < dataGridView2.Rows.Count; i++)
                    {
                        //Cập nhật lại số lượng sách sau khi insert đầu sách
        ...
        private void gridPhieuNhap_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            DataTable dt = pn.HienThiChiTietPhieuNhap(int.Parse(txtCTMPN.Text));
            if (dt.Rows.Count == 0)
            {
                btnCapnhat.Enabled = false;
                btnXoa.Enabled = false;
        ...
        private void dataGridView2_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dtable == null)
            {
                cboMaSach.SelectedValue = dataGridView2.CurrentRow.Cells[0].Value.ToString();
                txtSL.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
                txtDG.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();
                txtTT.Text = dataGridView2.CurrentRow.Cells[4].Value.ToString();
            }
        ...
        private void btnXoaPhieuNhap_Click(object sender, EventArgs e)
        {
            ...
            if (gridPhieuNhap.Rows.Count > 0)
            {
                ...
                dataGridView2.DataSource = pnDao.HienThiChiTietPhieuNhap(MaPN);
                btnCapnhat.Enabled = false;
                btnXoa.Enabled = false;
            }
            else
